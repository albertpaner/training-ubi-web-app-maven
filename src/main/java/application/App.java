...
public class App {
	...
	public static void main(String args[]) throws NoSuchAlgorithmException, ClassNotFoundException, SQLException {
		 ...
		 * int bobServiceResult = bobService.registrazioneUtente("Bob@submarine.com",
		 * bobPswd, 2, "Bob", "Narvhal", 9,
		 * null, null, null, null, null, null, null);
		 */

		String bobPswd = "password";
		String hashedPswd = Hasher.hashSaltPassword(bobPswd);
		logMain.info("Hashed password: " + hashedPswd + " for user: Bob");
