...
<html>
  ...
  <body>
    <div class="containerTabelle">
        ...
        <table>
            ...
            <tr style="" class= "rigaTabellaOccupati">
                ...
                <td><%= evaluator.getNome() %></td>
                <td><%= evaluator.getCognome() %></td>
                <td><%= evaluator.getEmail() %> </td>
                <td><%= evaluator.getCount() %> </td>
            </tr>
            <%
                }
    ...
    <div class="containerButtons">
      <form action="distribute_evaluators" method="put">
        <input type="submit" value="preview" />
        <select name="soglia" id="soglia">
